...
class LocalIPStorage:
    ...
    def set_config_from_peer(self, config_data: Dict[str, Any], merge_local_changes: bool = False) -> None:
        ...
        # Broadcast config change event DISABLED
        # This was causing session invalidation issues when config sync occurs
        # Users must manually refresh to see changes
        # Note: Broadcasting removed to prevent session invalidation during peer-sync
